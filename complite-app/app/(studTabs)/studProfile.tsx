...
import { getProfile, sendReport, updateStudent } from "@/utils/database";
...
export default function studProfile() {
  ...
  const editProfile = async () => {
    try {
      const studid = await AsyncStorage.getItem('accountId');
      const update = await updateStudent(studid, username, password);
      if (update.success){
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        <View style={styles.headerContent}>
          ...
          <Text style={{color:COLORS.background}}>{points}</Text>
          <Text style={{color:COLORS.background}}>{grades}</Text>
      ...
      <View style={styles.profileSection}>
        ...
        <View style={styles.infoContainer}>
          <Text style={styles.nameText}>{firstname} {middlename} {lastname}</Text>
